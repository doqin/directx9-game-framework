...
namespace Demo {
    ...
    public:
        ...
        void Init(DX9GF::GraphicsDevice* gd, DX9GF::Camera* worldCamera, DX9GF::Camera* uiCamera, std::shared_ptr<Player> p, std::shared_ptr<DX9GF::ColliderManager> cm, std::shared_ptr<DX9GF::SaveManager> sm, std::shared_ptr<DX9GF::Font> font, std::shared_ptr<DX9GF::CommandBuffer> drawBuffer);
