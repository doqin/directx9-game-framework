...
void Demo::CupidEnemy::Init(DX9GF::GraphicsDevice* graphicsDevice, DX9GF::Camera* camera)
{
	...
	texture->LoadTexture(L"bubble-Sheet.png"); // TODO: enemy img
	...
	heartTexture->LoadTexture(L"bubbleprojectile.png"); // TODO: Heart img
	...
	arrowTexture->LoadTexture(L"bubbleprojectile.png"); // TODO: Arrow img
